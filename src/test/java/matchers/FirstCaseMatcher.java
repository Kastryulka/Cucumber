...
public class FirstCaseMatcher {
    ...
    public void subcategoriesCountIsCorrect(List<Link> subcategories, Integer expectedCount){
        Assertions.assertTrue(subcategories.size()>expectedCount, "категорий меньше " + expectedCount.toString());
    }
